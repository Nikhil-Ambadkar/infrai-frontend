                ...
                <div className="pagetitle">
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">
                                <a href="#">Renovation of Highland Ave 13 </a>
                            </li>
                            <li className="active">New subproject</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            ...
                            <div className='tab-container my-4 mx-0'>
                                ...
                                <button type='button' className={`btn btn-default ${activeComponent == 2 ? ` active` : null} `} onClick={() => changeActiveComponent(2)}>Area</button>
                                <button type='button' className={`btn btn-default ${activeComponent == 3 ? ` active` : null} `} onClick={() => changeActiveComponent(3)}>Deliverables</button>
                                <button type='button' className={`btn btn-default ${activeComponent == 4 ? ` active` : null} `} onClick={() => changeActiveComponent(4)}>Planning</button>
                            </div>
                        </div>
                    </div>
                </div>
