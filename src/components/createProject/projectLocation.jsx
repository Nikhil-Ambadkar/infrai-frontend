...
function ProjectLocation({ props }) {
  ...
  const addLatLng = (latLng, index, formData) => {
    ...
    console.log(formData.areaLatLng);
    setFormData({ ...formData });
  };
    ...
    <form className="map-body">
      <div className="black-ribbon d-flex align-items-center justify-content-between">
        ...
        <button
          type="submit"
          className={`btn ${
            confirmProjectAreaButton == true ? null : "disabled"
          }`}
      ...
      <div className="map-container">
        ...
        {isLoaded ? (
          ...
          >
            ...
            {path.length > 0 && (
              <Polygon paths={path} options={geometryOptions} />
            )}
            ...
            <div className="map-area map-overlay">
                ...
                {areaTypes.map((areaType) => (
                  <button
                    ...
                    className={`btn btn-lg ${
                      formData.areaType === areaType ? "active" : ""
                    }`}
              ...
              {formData.areaLatLng.map((latLng, index) => (
                <div
                  key="index"
                  className={`poi-input ${latLng == "" ? "empty" : null} ${
                    index === selectedInput ? "editable" : ""
